...
QT_MOC_LITERAL(1, 4, 16), // "message_received"
QT_MOC_LITERAL(2, 21, 0) // ""

    },
    "UDP\0message_received\0"
};
...
void UDP::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->message_received(); break;
        default: ;
        }
        ...
        {
            typedef void (UDP::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UDP::message_received)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject UDP::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_UDP.data,
      qt_meta_data_UDP,  qt_static_metacall, nullptr, nullptr}
};
