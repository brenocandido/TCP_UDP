...
QT_MOC_LITERAL(4, 42, 12) // "start_server"

    },
    "TCP_Server\0messageReceived\0\0newConnection\0"
    "start_server"
};
...
void TCP_Server::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->start_server(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (TCP_Server::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TCP_Server::messageReceived)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TCP_Server::messageReceived()
{
